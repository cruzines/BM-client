...
function PageNotFound() {
    ...
    return (
        <div>
        <h1 style={{ color: '#4F6F57', textAlign: 'center', marginBottom: 12, marginTop: 10}}> 404 NOT FOUND<br />  God created the world in six days and he's now resting. <br /> Go home.</h1>
